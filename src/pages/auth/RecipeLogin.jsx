...
//       // Mock user data for recipe center
//       const userData = {
//         auth_id: 4,
//         full_name: "Recipe Center",
//         phone: phone,
//         center_name: "Healthy Recipes Hub",
...
import recipeBg from "../../assets/images/login-img.avif";
...
const RecipeLogin = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center px-4 py-4 relative overflow-hidden bg-cover bg-center pt-20"
      style={{
    ...
    >
      ...
      <div className="absolute top-20 left-20 w-72 h-72 bg-emerald-500/20 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
      <div className="absolute top-40 right-20 w-72 h-72 bg-teal-500/20 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-green-500/20 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
          {/* Header */}
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-2 text-white relative overflow-hidden">
          ...
          <div id="login-form" className="p-8">
            {!otpSent ? (
              <div className="space-y-6">
                ...
                {/* Recipe Center Specialization Info */}
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 mt-6">
                  <h3 className="font-semibold text-gray-800 mb-2 text-center">
                    Your Recipe Specialties
                  </h3>
                  <div className="grid grid-cols-4 gap-3">
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaUtensils className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Main Course</span>
                    </div>
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaCookieBite className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Desserts</span>
                    </div>
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaMortarPestle className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Spices</span>
                    </div>
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaUserTie className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Chef Tips</span>
                    </div>
                  </div>
                </div>
              </div>
