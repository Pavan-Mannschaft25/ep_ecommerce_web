...
//       // Mock user data for diet coach
//       const userData = {
//         auth_id: 2,
//         full_name: "Diet Coach",
//         phone: phone,
...
//           </div>
//           <h1 className="text-2xl font-bold text-gray-800">Diet Coach Login</h1>
...
import dietBg from "../../assets/images/login-img.avif";
    ...
    >
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
          ...
          {/* Form Container */}
          <div id="login-form" className="p-4">
            {!otpSent ? (
              <div className="space-y-6">
                ...
                {/* Diet Coach Specialization Info */}
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 mt-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaAppleAlt className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Nutrition</span>
                    </div>
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaClipboardList className="text-emerald-600 text-xl mb-1" />
                      <span className="text-xs text-gray-600">Meal Plans</span>
                    </div>
                    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg">
                      <FaHeartbeat className="text-emerald-600 text-xl mb-1" />
