...
const franchises = [
  {
    ...
    months: "10 Months",
    topScore: 93,
    image: "https://images.unsplash.com/photo-1615485737457-f07082c77813",
    category: "Protein & Nutrition",
    trending: true,
    verified: true,
    isNew: false,
    description:
      "India’s leading high-protein peanut butter brand trusted by fitness enthusiasts",
  },
  {
    id: 2,
    name: "MuscleBlaze Store",
    state: "Telangana",
    district: "Hyderabad",
    city: "Hyderabad",
    area: "Kukatpally",
    ...
    months: "12 Months",
    topScore: 91,
    image: "https://images.unsplash.com/photo-1594737625785-cd2c41d06f58",
    category: "Protein & Supplements",
    trending: true,
    verified: true,
    isNew: false,
    description:
      "India’s #1 sports nutrition brand offering protein powders and supplements",
  },
  {
    id: 3,
    ...
    verified: true,
    isNew: false,
    description: "Affordable high-quality protein and fitness nutrition brand",
  },
  {
    id: 4,
    name: "EatFit Protein Kitchen",
    state: "Andhra Pradesh",
    district: "Visakhapatnam",
    city: "Visakhapatnam",
    area: "MVP Colony",
    ...
    isNew: false,
    description:
      "Healthy protein-rich meals designed for fitness and lifestyle balance",
  },
  {
    id: 5,
    name: "CureFoods Protein Hub",
    state: "Telangana",
    district: "Rangareddy",
    city: "Hyderabad",
    area: "Gachibowli",
    ...
    verified: true,
    isNew: true,
    description: "Cloud-kitchen based protein meals and healthy food franchise",
  },
  {
    id: 6,
    name: "The Protein Bar",
    state: "Andhra Pradesh",
    district: "Guntur",
    city: "Guntur",
    area: "Brodipet",
    ...
    category: "Protein Cafe",
    trending: true,
    verified: true,
    isNew: false,
    description:
      "India’s first high-protein café chain focused on clean nutrition",
  },
];
